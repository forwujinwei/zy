...
public enum DistEnum {
   ...
   RESOURCE_DATA_SOURCE_PERSONAL("RDSP_002","人工导入"," RESOURCE_DATA_SOURCE"),
    ...
    TRADE_MARK_STATUS_REJECT("TMS_005","驳回","TRADE_MARK_STATUS"),
    TRADE_MARK_STATUS_OBJECTION("TMS_006","异议","TRADE_MARK_STATUS"),
    TRADE_MARK_STATUS_CERTIFICATE("TMS_007","下证","TRADE_MARK_STATUS"),
    TRADE_MARK_STATUS_OTHER("TMS_008","其他","TRADE_MARK_STATUS"),
    /*商标分类*/
