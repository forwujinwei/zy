...
public enum DistEnum {
   ...
   RESOURCE_DATA_SOURCE_PERSONAL("RDSP_002","人工导入"," RESOURCE_DATA_SOURCE"),
    ...
    /*商标状态*/
    TRADE_MARK_STATUS_APPLY("TMS_001","申请","TRADE_MARK_STATUS"),
    TRADE_MARK_STATUS_ACCEPT("TMS_002","下达受理","TRADE_MARK_STATUS"),
    TRADE_MARK_STATUS_REJECT("TMS_003","驳回","TRADE_MARK_STATUS"),
    TRADE_MARK_STATUS_OBJECTION("TMS_004","异议","TRADE_MARK_STATUS"),
    TRADE_MARK_STATUS_CERTIFICATE("TMS_005","下证","TRADE_MARK_STATUS"),
    TRADE_MARK_STATUS_OTHER("TMS_006","其他","TRADE_MARK_STATUS"),
    /*商标分类*/
