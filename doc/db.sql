...
/*资源个人池*/
CREATE TABLE `resource_personal_pool` (
  `id` VARCHAR(32) NOT NULL COMMENT '资源编号UUID',
  `name` VARCHAR(255) NOT NULL COMMENT '资源名称',
  `type_code` VARCHAR(32) NOT NULL COMMENT '资源类型编码',
  `type_des` VARCHAR(32) NOT NULL COMMENT '资源类型描述: 商标/专利/国际商标/国际专利',
  `source_code` VARCHAR(32) DEFAULT NULL COMMENT '资源来源code',
  `source_des` VARCHAR(32) DEFAULT NULL COMMENT '资源来源描述:商桥/电销/400/QQ/其他',
  `field_des` VARCHAR(63) NOT NULL COMMENT '资源所属行业描述',
  `status_code` VARCHAR(32) NOT NULL COMMENT '资源状态编码',
  `status_des` VARCHAR(32) NOT NULL COMMENT '资源状态描述:待确认/确认/放弃',
  `intent_code` VARCHAR(63) DEFAULT NULL COMMENT '客户最终意向编码',
  `intent_des` VARCHAR(63) DEFAULT NULL COMMENT '客户最终意向描述',
  `across_code` VARCHAR(63) DEFAULT NULL COMMENT '交叉类型编码',
  `across_des` VARCHAR(63) DEFAULT NULL COMMENT '交叉类型描述: 本站/盛凡/清上',
  `link_man` VARCHAR(50) NOT NULL COMMENT '联系人',
  `phone_number` VARCHAR(32) NOT NULL COMMENT '联系电话',
  `qq_number` VARCHAR(32) NOT NULL COMMENT 'qq号码',
  `adviser` VARCHAR(50) NOT NULL COMMENT '顾问',
  `end_revisit_date` DATETIME DEFAULT NULL COMMENT '最后回访时间',
  `submit_by` VARCHAR(50) NOT NULL COMMENT '创建人',
  `submit_date` TIMESTAMP NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '提交时间',
  `sure_by` VARCHAR(50) NOT NULL COMMENT '创建人',
  `sure_date` TIMESTAMP NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '提交时间',
  ...
  PRIMARY KEY (`id`)
) ENGINE=INNODB DEFAULT CHARSET=utf8 COMMENT='资源个人池'

/*回访记录表*/
CREATE TABLE revisit_record(
  `id` VARCHAR(32) NOT NULL COMMENT '回访UUID',
  `resource_id` VARCHAR(32) NOT NULL COMMENT '回访UUID',
  `intent_code` VARCHAR(63) DEFAULT NULL COMMENT '客户最终意向编码',
  `intent_des` VARCHAR(63) DEFAULT NULL COMMENT '客户最终意向描述',
  revisit_remark VARCHAR(255) DEFAULT NULL COMMENT '记录信息',
  `adviser` VARCHAR(50) NOT NULL COMMENT '顾问',
  `revisit_date` DATETIME NOT NULL COMMENT '回访时间',
  `create_by` VARCHAR(50) NOT NULL COMMENT '创建人',
  `create_date` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
